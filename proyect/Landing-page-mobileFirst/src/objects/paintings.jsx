...
const paintings = [
    ...
    { src: cuadro14, name: 'Aurora', price: `$${1234}`, offer: false, description: 'Cuadro en acrílico, con espátula, realizado sobre bastidor de madera. Detalles en tonos contrastantes aplicados en capas gruesas.', size: '80x60', sold: false},
